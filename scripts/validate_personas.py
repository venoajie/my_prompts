...
# Version: 3.0 (Refactored for Testability)
...
# Import functions that are now safe to import
from validate_personas import find_all_personas, load_config

def main(active_stati):
    """Scans active personas and generates a YAML manifest using injected dependencies."""
    ...
    for persona_path in all_persona_paths:
        try:
            ...
            # Use the injected active_stati list
...
if __name__ == "__main__":
    # This block now handles configuration loading for command-line execution
    ...
    # Run the main logic with the loaded config
